...
# Move the focused window along with you, ctrl+super for the same workspace number.
# Set explicitly rather than relying on Gnome's own default, which isn't consistently
# bound to this combo across Gnome/Ubuntu versions. Ctrl rather than Shift, since Shift
# changes what a digit key sends on many layouts (e.g. Shift+3 is "§" on German
# keyboards), which would make the binding impossible to press at all on those layouts.
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/ binding '<Control><Alt>2'
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom3/ binding '<Control><Alt>1'

# Start PhpStorm directly, independent of its dock position
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom7/ name 'PhpStorm'
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom7/ command '/usr/local/bin/phpstorm'
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom7/ binding '<Control><Alt>3'
