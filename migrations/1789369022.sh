...
# Repair an Omakupt install that has been carried onto Ubuntu 26.04, which renamed
# some of the packages Omakupt installs and reshuffled Yaru's accent variants.
